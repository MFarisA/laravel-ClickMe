...
@section('main-dashboard')
    <div class="container mx-auto p-4">
        <section class="relative bg-neutral-800 py-24">
            <div class="w-full max-w-7xl mx-auto px-6 lg:px-8 overflow-x-auto">
                <div class="flex flex-col md:flex-row max-md:gap-3 items-center justify-between mb-5">
                    ...
                    <div class="flex items-center gap-px rounded-lg bg-gray-100 p-1">
                        <button
                            class="rounded-lg py-2.5 px-5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-indigo-600">Day</button>
                        <button
                            class="rounded-lg py-2.5 px-5 text-sm font-medium text-indigo-600 bg-white transition-all duration-300 hover:bg-white hover:text-indigo-600">Week</button>
                        <button
                            class="rounded-lg py-2.5 px-5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-indigo-600">Month</button>
                    </div>
                    <button
                ...
                <div class=" relative">
                    ...
                    <div class="hidden grid-cols-7 sm:grid w-full overflow-x-auto">
                        <div
                            class="h-32 lg:h-28 p-0.5 md:p-3.5   border-t border-r border-gray-200 flex items-end transition-all hover:bg-stone-100">
                            <span class="text-xs font-semibold text-gray-400">07:00 am</span>
                        </div>
                        <div
                            class="h-32 lg:h-28 p-0.5 md:p-3.5   border-t border-r border-gray-200 transition-all hover:bg-stone-100">
                        </div>
                        <div
                            class="h-32 lg:h-28 p-0.5 md:p-3.5   border-t border-r border-gray-200 transition-all hover:bg-stone-100">
                        </div>
                        ...
                        <div
                            class="h-32 lg:h-28 p-0.5 md:p-3.5   border-t  border-gray-200 transition-all hover:bg-stone-100">
                        </div>
